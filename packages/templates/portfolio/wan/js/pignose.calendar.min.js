...
! function(e, t) {
    ...
    ! function(f) {
        ...
        m = function(e, t) {
            var n, s, a = l(e),
                r = a[0],
                i = t[1];
            return e = a[1], r && (n = b(r = o(r, i))), r ? e = n && n.normalize ? n.normalize(e, (s = i, function(e) {
                return o(e, s)
            })) : o(e, i) : (r = (a = l(e = o(e, i)))[0], e = a[1], r && (n = b(r))), {
                f: r ? r + "!" + e : e,
                n: e,
                pr: r,
                p: n
            ...
            var a, r, i, o, l, u, d, c = [],
                h = typeof n;
            if (u = S(s = s || e), "undefined" === h || "function" === h) {
                ...
                else if (M(p, r) || M(y, r) || M(v, r)) c[l] = b(r);
                else {
            ...
            if ("string" == typeof e) return g[e] ? g[e](t) : b(m(e, S(t)).f);
            if (!e.splice) {
        ...
        function i(e, t, n) {
            var s, a = Math.min(e.length, t.length),
                ...
                i = 0;
            for (s = 0; s < a; s++)(n && e[s] !== t[s] || !n && b(e[s]) !== b(t[s])) && i++;
            return i + r
        }
        ...
        function C(e, t) {
            null != _.deprecationHandler && _.deprecationHandler(e, t), Y[e] || (S(t), Y[e] = !0)
        }
        ...
        function V(e, t) {
            return e.isValid() ? (t = I(t, e.localeData()), U[t] = U[t] || function(s) {
        ...
        E("Y", 0, 0, function() {
            ...
            t[fe] = 2 === e.length ? _.parseTwoDigitYear(e) : b(e)
        }), ce("YY", function(e, t) {
        ...
        E("H", ["HH", 2], 0, "hour"), E("h", ["hh", 2], 0, Be), E("k", ["kk", 2], 0, function() {
            ...
            t[pe] = b(e), w(n).bigHour = !0
        }), ce("hmm", function(e, t, n) {
            var s = e.length - 2;
            t[pe] = b(e.substr(0, s)), t[ye] = b(e.substr(s)), w(n).bigHour = !0
        }), ce("hmmss", function(e, t, n) {
            var s = e.length - 4,
                a = e.length - 2;
            t[pe] = b(e.substr(0, s)), t[ye] = b(e.substr(s, 2)), t[_e] = b(e.substr(a)), w(n).bigHour = !0
        }), ce("Hmm", function(e, t, n) {
            var s = e.length - 2;
            t[pe] = b(e.substr(0, s)), t[ye] = b(e.substr(s))
        }), ce("Hmmss", function(e, t, n) {
            var s = e.length - 4,
                a = e.length - 2;
            t[pe] = b(e.substr(0, s)), t[ye] = b(e.substr(s, 2)), t[_e] = b(e.substr(a))
        });
        ...
        function ct(e) {
            ...
            if (!e._d) {
                ...
                for (o = e, l = new Date(_.now()), s = o._useUTC ? [l.getUTCFullYear(), l.getUTCMonth(), l.getUTCDate()] : [l.getFullYear(), l.getMonth(), l.getDate()], e._w && null == e._a[ge] && null == e._a[me] && function(e) {
                        var t, n, s, a, r, i, o, l;
                        if (null != (t = e._w).GG || null != t.W || null != t.E) r = 1, i = 4, n = dt(t.GG, e._a[fe], Ge(St(), 1, 4).year), s = dt(t.W, 1), ((a = dt(t.E, 1)) < 1 || 7 < a) && (l = !0);
                        else {
        ...
        function Mt(e) {
            ...
            if (h) {
                ...
                if (n = f, s = e, (t = h[1]) && Ie.indexOf(t) !== new Date(n[0], n[1], n[2]).getDay() && (w(s).weekdayMismatch = !0, !(s._isValid = !1))) return;
            ...
            if (e._f !== _.ISO_8601)
                if (e._f !== _.RFC_2822) {
                    ...
                    var t, n, s, a, r, i, o, l, u = "" + e._i,
                        d = u.length,
                        c = 0;
                    for (s = I(e._f, e._locale).match(j) || [], t = 0; t < s.length; t++) a = s[t], (n = (u.match((p = a, y = e, v(oe, p) ? oe[p](y._strict, y._locale) : new RegExp(ue(p.replace("\\", "").replace(/\\(\[)|\\(\])|\[([^\]\[]*)\]|\\(.)/g, function(e, t, n, s, a) {
                        return t || n || s || a
        ...
        function Tt(e) {
            ...
            this._isValid = function(e) {
                for (var t in e)
                    if (-1 === be.call(xt, t) || null != e[t] && isNaN(e[t])) return !1;
                for (var n = !1, s = 0; s < xt.length; ++s)
                    if (e[xt[s]]) {
                        if (n) return !1;
                        parseFloat(e[xt[s]]) !== b(e[xt[s]]) && (n = !0)
                    }
                return !0
        ...
        function Rt(e, t) {
            var n, s;
            return t._isUTC ? (n = t.clone(), s = (k(e) || c(e) ? e.valueOf() : St(e).valueOf()) - n.valueOf(), n._d.setTime(n._d.valueOf() + s), _.updateOffset(n, !1), n) : St(e).local()
        }
        ...
        function Gt(e, t) {
            ...
            return Wt(e) ? l = {
                ...
                m: Et(u[7], n),
                s: Et(u[8], n)
            }) : null == l ? l = {} : "object" == typeof l && ("from" in l || "to" in l) && (r = St(l.from), i = St(l.to), a = r.isValid() && i.isValid() ? (i = Rt(i, r), r.isBefore(i) ? o = Vt(r, i) : ((o = Vt(i, r)).milliseconds = -o.milliseconds, o.months = -o.months), o) : {
                milliseconds: 0,
                months: 0
        ...
        on.add = Jt, on.calendar = function(e, t) {
            ...
            return this.format(r || this.localeData().calendar(a, this, St(n)))
        }, on.clone = function() {
            return new M(this)
            ...
            return this.isValid() && (k(e) && e.isValid() || St(e).isValid()) ? Gt({
                to: this,
                from: e
            ...
            return n.year() < 0 || 9999 < n.year() ? V(n, t ? "YYYYYY-MM-DD[T]HH:mm:ss.SSS[Z]" : "YYYYYY-MM-DD[T]HH:mm:ss.SSSZ") : O(Date.prototype.toISOString) ? t ? this.toDate().toISOString() : new Date(this.valueOf() + 60 * this.utcOffset() * 1e3).toISOString().replace("Z", V(n, "Z")) : V(n, t ? "YYYY-MM-DD[T]HH:mm:ss.SSS[Z]" : "YYYY-MM-DD[T]HH:mm:ss.SSSZ")
        }, on.inspect = function() {
        ...
        }, on.year = Se, on.isLeapYear = function() {
            return De(this.year())
        ...
        }, on.dates = n("dates accessor is deprecated. Use date instead.", en), on.months = n("months accessor is deprecated. Use month instead", Ae), on.years = n("years accessor is deprecated. Use year instead", Se), on.zone = n("moment().zone is deprecated, use moment().utcOffset instead. http://momentjs.com/guides/#/warnings/zone/", function(e, t) {
        ...
        un.calendar = function(e, t, n) {
            ...
            if (this._monthsParseExact) return function(e, t, n) {
                ...
                return n ? "MMM" === t ? -1 !== (a = be.call(this._shortMonthsParse, i)) ? a : null : -1 !== (a = be.call(this._longMonthsParse, i)) ? a : null : "MMM" === t ? -1 !== (a = be.call(this._shortMonthsParse, i)) ? a : -1 !== (a = be.call(this._longMonthsParse, i)) ? a : null : -1 !== (a = be.call(this._longMonthsParse, i)) ? a : -1 !== (a = be.call(this._shortMonthsParse, i)) ? a : null
            }.call(this, e, t, n);
        ...
        return Un.isValid = function() {
        ...
        }, Un.asMilliseconds = vn, Un.asSeconds = wn, Un.asMinutes = Mn, Un.asHours = kn, Un.asDays = Dn, Un.asWeeks = bn, Un.asMonths = Sn, Un.asYears = Yn, Un.valueOf = function() {
            ...
            n._d = new Date(b(e))
        }), _.version = "2.22.2", e = St, _.fn = on, _.min = function() {
    ...
    a("methods/init", ["../manager/index", "../component/classNames", "../component/helper", "../component/models", "../component/global", "./configure", "jquery", "moment"], function(L, A, H, R, F, t, j, N) {
        ...
        return function(e) {
            var b = this;
            b.settings = {}, t.call(b, e), b.global = {
                calendarHtml: H.format('<div class="{0} {0}-{4}">                                    <div class="{1}">                                      <a href="#" class="{1}-nav {1}-prev">                                          <span class="icon-arrow-left {1}-icon"></span>                                      </a>                                      <div class="{1}-date">                                          <span class="{1}-month"></span>                                          <span class="{1}-year"></span>                                      </div>                                      <a href="#" class="{1}-nav {1}-next">                                          <span class="icon-arrow-right {1}-icon"></span>                                      </a>                                    </div>                                    <div class="{2}"></div>                                    <div class="{3}"></div>                                  </div>', H.getClass(R.name), A.top, A.header, A.body, b.settings.theme),
                calendarButtonsHtml: H.format('<div class="{0}-group">                                            <a href="#" class="{0} {0}-cancel">{1}</a>                                            <a href="#" class="{0} {0}-apply">{2}</a>                                          </div>', A.button, b.settings.controls.cancel, b.settings.controls.ok),
            ...
            return b.each(function() {
                var v = j(this),
                    w = {
                        initialize: null,
                        element: v,
                        calendar: j(b.global.calendarHtml),
                        input: v.is("input"),
                        renderer: null,
                        current: [null, null],
                        date: {
                        ...
                        dateManager: new L(b.settings.date),
                    ...
                    M = v;
                !0 === b.settings.initialize && (w.initialize = w.current[0] = w.dateManager.date.clone()), this.local = w, !0 === b.settings.reverse ? w.calendar.addClass(H.getSubClass("reverse")) : w.calendar.addClass(H.getSubClass("default"));
                for (var e = b.settings.week; e < b.settings.weeks.length + b.settings.week; e++) {
                    e < 0 && (e = F.languages.weeks.en.length - e);
                    var t = b.settings.weeks[e % b.settings.weeks.length];
                ...
                if (!0 === b.settings.buttons && (P = j(b.global.calendarButtonsHtml)).appendTo(w.calendar), !0 === w.input || !0 === b.settings.modal) {
                ...
                var k = function() {
                        ...
                        for (var i = n.format("YYYY-MM-DD"), o = s.format("YYYY-MM-DD"); n.format("YYYY-MM-DD") <= s.format("YYYY-MM-DD"); n.add(1, "days")) {
                            var l = n.format("YYYY-MM-DD"),
                                u = w.calendar.find(H.format('.{0}[data-date="{1}"]', H.getSubClass("unit"), l)).addClass(S);
                ...
                w.renderer = function() {
                    if (w.calendar.appendTo(M.empty()), w.calendar.find("." + A.top + "-year").text(w.dateManager.year), w.calendar.find("." + A.top + "-month").text(b.settings.monthsLong[w.dateManager.month - 1]), w.calendar.find(H.format(".{0}-prev .{0}-value", A.top)).text(b.settings.months[w.dateManager.prevMonth - 1].toUpperCase()), w.calendar.find(H.format(".{0}-next .{0}-value", A.top)).text(b.settings.months[w.dateManager.nextMonth - 1].toUpperCase()), !0 === b.settings.buttons && P) {
                        var a = v;
                        P.find("." + A.button).bind("click", function(e) {
                            ...
                            if (t.hasClass(A.button + "-apply")) {
                                ...
                                var n = "";
                                if (!0 === b.settings.toggle) n = w.storage.activeDates.join(", ");
                                else if (!0 === b.settings.multiple) {
                                    var s = [];
                                    null !== w.current[0] && s.push(w.current[0].format(b.settings.format)), null !== w.current[1] && s.push(w.current[1].format(b.settings.format)), n = s.join(" ~ ")
                                } else n = null === w.current[0] ? "" : N(w.current[0]).format(b.settings.format);
                                !0 === w.input && a.val(n).triggerHandler("change"), "function" == typeof b.settings.apply && b.settings.apply.call(w.calendar, w.current, w), M.triggerHandler("apply." + H.getClass(R.name))
                    ...
                    var e = w.calendar.find("." + A.body).empty(),
                        ...
                        s = t.weekday() - b.settings.week,
                        r = n.weekday() - b.settings.week;
                    s < 0 && (s += b.settings.weeks.length);
                    for (var d = [], c = [null === w.current[0] ? null : w.current[0].format("YYYY-MM-DD"), null === w.current[1] ? null : w.current[1].format("YYYY-MM-DD")], h = null === b.settings.minDate ? null : N(b.settings.minDate), f = null === b.settings.maxDate ? null : N(b.settings.maxDate), i = 0; i < s; i++) {
                    ...
                    for (var l = function(e) {
                            ...
                            if (0 < b.settings.enabledDates.length) - 1 === j.inArray(n, b.settings.enabledDates) && s.addClass(H.getSubClass("unitDisabled"));
                            else if (0 < b.settings.disabledWeekdays.length && -1 !== j.inArray(t.weekday(), b.settings.disabledWeekdays)) s.addClass(H.getSubClass("unitDisabled")).addClass(H.getSubClass("unitDisabledWeekdays"));
                            ...
                            else if (-1 !== j.inArray(n, b.settings.disabledDates)) s.addClass(H.getSubClass("unitDisabled"));
                            else if (0 < b.settings.disabledRanges.length)
                                for (var a = b.settings.disabledRanges.length, r = 0; r < a; r++) {
                                    var i = b.settings.disabledRanges[r];
                                    i.length;
                            ...
                            if (0 < b.settings.schedules.length && "object" === U(b.settings.scheduleOptions) && "object" === U(b.settings.scheduleOptions.colors)) {
                                var o = b.settings.schedules.filter(function(e) {
                                        return e.date === n
                                    }),
                                ...
                                if (0 < l.length) {
                                    var u = j(b.global.calendarScheduleContainerHtml);
                                    u.appendTo(s), l.map(function(e, t) {
                                        if (b.settings.scheduleOptions.colors[e]) {
                                            var n = b.settings.scheduleOptions.colors[e];
                                            j(H.format(b.global.calendarSchedulePinHtml, e, n)).appendTo(u)
                                        }
                                    })
                                }
                            }!0 === b.settings.toggle ? -1 !== j.inArray(n, w.storage.activeDates) && 0 < w.storage.activeDates.length ? s.addClass(T) : s.addClass(W) : !1 === s.hasClass(H.getSubClass("unitDisabled")) && (!0 === b.settings.multiple ? (c[0] && n === c[0] && s.addClass(O).addClass(x[0]), c[1] && n === c[1] && s.addClass(O).addClass(x[1])) : c[0] && n === c[0] && -1 === j.inArray(c[0], b.settings.disabledDates) && (b.settings.enabledDates.length < 1 || -1 !== j.inArray(c[0], b.settings.enabledDates)) && s.addClass(O).addClass(x[0])), d.push(s);
                            var g = v;
                            s.bind("click", function(e) {
                                ...
                                if (t.hasClass(H.getSubClass("unitDisabled"))) a = !0;
                                else if (!0 === w.input && !1 === b.settings.multiple && !1 === b.settings.buttons) g.val(N(n).format(b.settings.format)), M.triggerHandler("apply." + H.getClass(R.name));
                                else if (null !== w.initialize && w.initialize.format("YYYY-MM-DD") === n && !1 === b.settings.toggle);
                                else {
                                    if (!0 === b.settings.toggle) {
                                    ...
                                    } else if (!0 === t.hasClass(O) && !1 === b.settings.pickWeeks) !0 === b.settings.multiple && (t.hasClass(x[0]) ? s = 0 : x[1] && (s = 1)), t.removeClass(O).removeClass(x[s]), w.current[s] = null;
                                    else {
                                        if (!0 === b.settings.pickWeeks)
                                            if (!0 === t.hasClass(O) || !0 === t.hasClass(S)) {
                                                ...
                                                w.current[0] = N(n).startOf("week").add(b.settings.week, "days"), w.current[1] = N(n).endOf("week").add(b.settings.week, "days");
                                        ...
                                        else !0 === b.settings.multiple && (null === w.current[0] ? s = 0 : null === w.current[1] ? s = 1 : (s = 0, w.current[1] = null, w.calendar.find("." + O + "." + x[1]).removeClass(O).removeClass(x[1]))), w.calendar.find("." + O + "." + x[s]).removeClass(O).removeClass(x[s]), t.addClass(O).addClass(x[s]), w.current[s] = N(n);
                                        if (w.current[0] && w.current[1]) {
                                            ...
                                            if (!1 === function(e, t) {
                                                    var n = void 0;
                                                    for (var s in b.settings.disabledDates)
                                                        if (n = N(b.settings.disabledDates[s]), D(e, t, n)) return !1;
                                                    if (D(e, t, b.settings.maxDate)) return !1;
                                                    if (D(e, t, b.settings.minDate)) return !1;
                                                    for (var a in b.settings.disabledRanges) {
                                                        var r = b.settings.disabledRanges[a],
                                                            i = N(r[0]),
                                                            o = N(r[1]);
                                                    ...
                                                    var l = e.weekday(),
                                                        ...
                                                        d = void 0;
                                                    u < l && (d = l, l = u, u = d);
                                                    for (var c = 0, h = 0; c < b.settings.disabledWeekdays.length && h < 7; c++) {
                                                        h++;
                                                        var f = b.settings.disabledWeekdays[c];
                                                        if (l <= f && f <= u) return !1
                                                    }
                                                    return !0
                                                }(w.current[0], w.current[1]) && !1 === b.settings.selectOver && (w.current[0] = null, w.current[1] = null, w.calendar.find("." + O).removeClass(O).removeClass(x[0]).removeClass(x[1])), !0 === w.input && !1 === b.settings.buttons) {
                                                var h = [];
                                                null !== w.current[0] && h.push(w.current[0].format(b.settings.format)), null !== w.current[1] && h.push(w.current[1].format(b.settings.format)), t.val(h.join(", ")), M.trigger("apply." + H.getClass(R.name))
                                            }
                                        }
                                    }!0 === b.settings.multiple && (w.calendar.find("." + S).removeClass(S).removeClass(Y).removeClass(C), k.call()), 0 < b.settings.schedules.length && (w.storage.schedules = b.settings.schedules.filter(function(e) {
                                        return e.date === n
                                    }))
                                }
                                var f = function(e) {
                                    w.date.all.push(e), ! function(e) {
                                        if (-1 !== b.settings.disabledDates.indexOf(e)) return !1;
                                        if (0 <= e.diff(b.settings.maxDate)) return !1;
                                        if (e.diff(b.settings.minDate) <= 0) return !1;
                                        for (var t in b.settings.disabledRanges) {
                                            var n = b.settings.disabledRanges[t],
                                                s = N(n[0]),
                                                a = N(n[1]);
                                            if (D(s, a, e)) return !1
                                        }
                                        var r = e.weekday();
                                        return -1 === b.settings.disabledWeekdays.indexOf(r)
                                ...
                                !1 === a && (w.initialize = null, "function" == typeof b.settings.select && b.settings.select.call(t, w.current, w)), "function" == typeof b.settings.click && b.settings.click.call(t, e, w)
                            })
                        }, u = w.dateManager.firstDay; u <= w.dateManager.lastDay; u++) l(u);
                    for (var m = r + 1; d.length < 5 * b.settings.weeks.length; m++) {
                    ...
                    for (var p = null, y = 0; y < d.length; y++) {
                        var _ = d[y];
                        (y % b.settings.weeks.length == 0 || y + 1 >= d.length) && (null !== p && p.appendTo(e), y + 1 < d.length && (p = j(H.format('<div class="{0}"></div>', H.getSubClass("row"))))), p.append(_)
                    }
                    w.calendar.find("." + A.top + "-nav").bind("click", function(e) {
                        e.preventDefault(), e.stopPropagation();
                        var t = j(this),
                            n = "unkown";
                        t.hasClass(A.top + "-prev") ? (n = "prev", w.dateManager = new L(w.dateManager.date.clone().add(-1, "months"))) : t.hasClass(A.top + "-next") && (n = "next", w.dateManager = new L(w.dateManager.date.clone().add(1, "months"))), "function" == typeof b.settings.page && b.settings.page.call(t, {
                            type: n,
                            year: w.dateManager.year,
                            month: w.dateManager.month,
                            day: w.dateManager.day
                        }, w), "function" == typeof b.settings[n] && b.settings[n].call(t, {
                            type: n,
                            year: w.dateManager.year,
                            month: w.dateManager.month,
                            day: w.dateManager.day
                        }, w), w.renderer.call()
                    }), !0 === b.settings.multiple && (w.calendar.find("." + S).removeClass(S).removeClass(Y).removeClass(C), k.call())
                }, w.renderer.call(), v[0][R.name] = w, "function" == typeof b.settings.init && b.settings.init.call(v, w)
            })
        }
